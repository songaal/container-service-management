...
sequelize model:create --name deploy_history --attributes groupId:string,deployTime:date,user:string,result:string,service:string,deployId:string,deployEndTime:date,deployType:string
...
sequelize model:create --name file_hst --attributes userId:string,fileName:string,initTime:date,fileSize:string,phase:string,type:string,fileKey:string,checkTime:date
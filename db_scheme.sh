...
sequelize model:create --name deploy_histories --attributes groupId:string,deployTime:date,user:string,result:string,service:string,deployId:string,deployEndTime:string,deployType:string